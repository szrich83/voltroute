...
function calculate(){
  try {
    errorText().Set("");
    const result=calculateTrip(New_1(Number(battery().Get()), Number(consumption().Get()), Number(distance().Get()), Number(price().Get()), Number(soc().Get()), Number(chargingPower().Get())));
